...
class __TwigTemplate_703664b3555bf50f0778e10e8c6d3aa9a5b44297d8d4808f1e76ebcf07e3f4f6 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t\t<a href=\"index.php?route=information/contact\"><button type=\"button\" style='float:left; '  class=\"btn col-md-6 col-6 btn-primary btn-lg btn-block mob_text\">
\t\t\t\t\t\t\t\t\t\t\tRequest for Price
\t\t\t\t\t\t\t\t\t\t</button></a>
\t\t\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t\t</div>
