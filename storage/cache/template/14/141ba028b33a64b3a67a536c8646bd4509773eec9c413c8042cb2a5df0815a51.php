...
class __TwigTemplate_12047f494ebf7959bf17ad21756e9683539c1188c3090a185d7928ed6dc85c70 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t<a href=\"\"><button class=\"btn bg-white col-md-5 col-12 mob_padd\" style=\"font-size:14px\">
\t\t\t\t\t\t\t\t\tTake A Look</button>
\t\t\t\t\t\t\t\t</a>
\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t</div>
