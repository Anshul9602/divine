...
class __TwigTemplate_095c4a693824cfd3f12e42ea6318555028d1a5a08d9ec12c26e84441286eb00c extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t\t\t<a href=\"#\" class=\"btn btn-header-link collapsed\" data-toggle=\"collapse\" data-target=\"#faq2\" aria-expanded=\"true\" aria-controls=\"faq2\" style=\"width:100%\">MATERIAL & DETAILS<i class=\"pe-7s-angle-down\" style=\"float: right;margin-top: -20px;    height: 24px;    font-size: 53px;\"></i>
  </a>
\t\t\t\t\t\t\t\t\t\t</div>
