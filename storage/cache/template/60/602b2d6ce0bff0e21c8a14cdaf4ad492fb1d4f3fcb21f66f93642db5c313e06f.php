...
class __TwigTemplate_93cc8ca35e80ae4a3008991fa6f4d0231bb024dd80db202f6266071d3f2c895c extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t";
                ...
                if (twig_get_attribute($this->env, $this->source, $context["product"], "price", [], "any", false, false, false, 151)) {
                    // line 152
                    echo "\t\t\t\t\t\t\t\t\t<a class=\"row mt-2\" style=\"justify-content: space-around;\">
\t\t\t\t\t\t\t\t\t\t<a href=\"index.php?route=information/contact\"><button type=\"button\" style='float:left; max-width:49%'  class=\"btn col-md-6 col-6 btn-primary btn-lg btn-block mob_text\">
\t\t\t\t\t\t\t\t\t\t\tRequest for Price
\t\t\t\t\t\t\t\t\t\t</button></a>
\t\t\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t\t</div>
