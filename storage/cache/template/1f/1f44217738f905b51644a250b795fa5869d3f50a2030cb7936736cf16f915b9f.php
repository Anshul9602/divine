...
class __TwigTemplate_1657348e8af72ca096af466bf8fbe0d12506834c098e42c942ec6a16c2a6820c extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t<button class=\"btn btn-primary col-4\" style=\"font-size:14px\"> Take A Look</button>
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t
\t\t\t\t\t\t</div>
\t\t\t\t\t</div>
