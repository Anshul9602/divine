...
class __TwigTemplate_bcbd10d30ebe85392a2036c825fd1af648e01da056b665c2490dc3a397aa2d7b extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\tvar card = `<div class=\"col-md-3 col-sm-6 mt-3\">
\t\t<!-- product grid start -->
...
\t\t\t\t\t\t</p>
<button type=\"button\"btnid=\"\${product[i].productid}\" class=\"btn btn-primary \">remove</button>
\t\t\t\t\t</div>
\t\t\t</div>
\t\t</div>
\t</div>\t
...
";
    ...
    {
        return array (  144 => 90,  84 => 32,  73 => 29,  70 => 28,  66 => 27,  37 => 1,);
    }
