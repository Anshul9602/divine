...
class __TwigTemplate_dc58707364040d0f6c5a070a712f5674ce77dabb5be4cbb062d94c8332efe729 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t<button class=\"btn btn-primary col-6\"> Take A Look</button>
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t
\t\t\t\t\t\t</div>
\t\t\t\t\t</div>
