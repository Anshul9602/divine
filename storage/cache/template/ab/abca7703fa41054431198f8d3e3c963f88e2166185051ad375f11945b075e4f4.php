...
class __TwigTemplate_f9e0ed6a6c5739161ba0c30b6ea264d5bc06db36908e5a928c1f7456022be125 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t<button class=\"btn btn-primary col-6\" style=\"font-size:14px\"> Take A Look</button>
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t
\t\t\t\t\t\t</div>
\t\t\t\t\t</div>
