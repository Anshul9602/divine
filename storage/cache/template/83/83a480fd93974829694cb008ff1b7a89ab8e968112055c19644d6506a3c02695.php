...
class __TwigTemplate_bc2756f311759b3fd3e0f28d18310d46af2bd5b109e7ac4b1090d879296ae7de extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t";
                ...
                if (twig_get_attribute($this->env, $this->source, $context["product"], "price", [], "any", false, false, false, 151)) {
                    // line 152
                    echo "\t\t\t\t\t\t\t\t\t  ";
                    if ((twig_get_attribute($this->env, $this->source, $context["product"], "price", [], "any", false, false, false, 152) == "₹0")) {
                        // line 153
                        echo "\t\t\t\t\t\t\t\t\t 
...
$context["product"], "price", [], "any", false, false, false, 161) == "\$0")) {
                        echo " 
\t\t\t\t\t\t\t\t\t <div class=\"row mt-2\" style=\"justify-content: space-around;\">
\t\t\t\t\t\t\t\t\t\t<a href=\"index.php?route=information/contact\"><button type=\"button\" style='float:left; max-width:100%'  class=\"btn col-md-6 col-6 btn-primary btn-lg btn-block mob_text\">
\t\t\t\t\t\t\t\t\t\t\tRequest for Price
...
\t\t\t\t\t\t\t\t\t\t\t";
                            // line 174
                            echo twig_get_attribute($this->env, $this->source, $context["product"], "special", [], "any", false, false, false, 174);
                            // line 175
                            echo "</span>
