...
class __TwigTemplate_d60f5f7f2d26b4bab480a603fed249cf0eda552dc675ef76ab1d79ada1b9c871 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t<div class=\"row justify-content-space-around\">
\t\t\t\t<div class=\"col-md-6\">
\t\t\t\t\t<img src=\"image/banner/e5.png\" alt=\"\" class=\"img-responsive\">
...
\t\t\t\t\t<div class=\"col-md-12\">
\t\t\t\t\t\t<ul class=\"mt-4\">
\t\t\t\t\t\t\t<li>At our jewelry shop, we understand that every piece of jewelry holds sentimental value and becomes a cherished part of your story.</li>
\t\t\t\t\t\t\t<li>Whether you're searching for a show-stopping statement piece for a special occasion or a timeless accessory to elevate your everyday style, our Founder's Choice collection has something to captivate every discerning taste.</li>
\t\t\t\t\t\t\t<li></li>
\t\t\t\t\t\t</ul>
\t\t\t\t\t</div>
\t\t\t\t\t<div class=\"col-md-12 mt-3\">
\t\t\t\t\t\t<a href=\"index.php?route=common/aboutus\" style=\"color:#fff;padding:10px;background:black;font-size: 16px;font-weight: 500;\">
\t\t\t\t\t\t\tExplor Now 
