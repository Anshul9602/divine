...
class __TwigTemplate_df69e2765638552f2b911dc303c7059eef08436cd322f694e0a55ad309716e1d extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["banner"]) {
            // line 78
            echo "\t\t\t\t<a href=\"";
            echo twig_get_attribute($this->env, $this->source, $context["banner"], "link", [], "any", false, false, false, 78);
            echo "\">
\t\t\t\t\t<img src=\"";
            // line 79
            echo twig_get_attribute($this->env, $this->source, $context["banner"], "image", [], "any", false, false, false, 79);
            echo "\" alt=\"\" class=\"img-response slider-img\">
\t\t\t\t</a>
\t\t\t\t";
        }
...
\t\t\t\t<div class=\"main main_mob\" style=\"background-color: #b3f0e0;margin: 80px;width:100%;\">
\t\t\t\t\t<div class=\"row\">
...
\t\t\t\t\t\t\t\t<img class=\" \" src=\"image/banner/take1.png\"width=\"70\" style=\"transform: rotate(-30deg);\" alt=\"\">
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t
\t\t\t\t\t\t\t<h4 class=\"mt-2 col-12\"style=\"    font-family: 'Montserrat', sans-serif !important;\">Ancient Jewellery Collection</h4>
\t\t\t\t\t\t\t<h6 class=\"mt-2 col-12\" style=\"    font-family: 'Montserrat', sans-serif !important;\">light in weight . 14 Karat gold . Opal</h6>
\t\t\t\t\t\t\t<div class=\"col-12 text-center mt-4\">
\t\t\t\t\t\t\t\t<button class=\"btn bg-white col-5\" style=\"font-size:14px\"> Take A Look</button>
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t
\t\t\t\t\t\t</div>
\t\t\t\t\t</div>
...
";
    ...
    {
        return array (  500 => 396,  403 => 301,  214 => 112,  203 => 107,  198 => 105,  194 => 104,  189 => 101,  185 => 100,  165 => 82,  156 => 79,  151 => 78,  147 => 77,  135 => 67,  122 => 60,  117 => 58,  112 => 55,  108 => 54,  84 => 32,  75 => 29,  70 => 28,  66 => 27,  37 => 1,);
    }
