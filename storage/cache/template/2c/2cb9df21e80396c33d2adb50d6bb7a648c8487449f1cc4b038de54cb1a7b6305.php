...
class __TwigTemplate_aa0a33b1e0a4c9077a8c642234259af96dd788beea60c5f4a8f27b5c87b2bc0b extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t\t\t<i class=\"pe-7s-angle-down arr\" style=\"float: right;    margin-top: -20px;    height: 24px;    font-size: 35px;\"></i>
\t\t\t\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t\t\t\t</a>
\t\t\t\t\t\t\t\t\t\t</div>
...
\t\t\t\t\t\t\t\t\t\t\t<a href=\"#\" class=\"btn btn-header-link collapsed\" data-toggle=\"collapse\" data-target=\"#faq2\" aria-expanded=\"true\" aria-controls=\"faq2\" style=\"width:100%\">MATERIAL & DETAILS<i class=\"pe-7s-angle-down\" style=\"float: right;margin-top: -20px;    height: 24px;    font-size: 35px;\"></i>
  </a>
\t\t\t\t\t\t\t\t\t\t</div>
