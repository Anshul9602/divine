...
class __TwigTemplate_f84d83cc21b39f9f1223111c0403dcf24b1118564f5af4a39e3b9b416ab0ee64 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t<h6 class=\"mt-2 col-12\">light in weight . 14 Karat gold . Opal</h6>
\t\t\t\t\t\t\t<div class=\"col-12 text-center mt-4\">
\t\t\t\t\t\t\t\t<button class=\"btn btn-primary col-5\" style=\"font-size:14px\"> Take A Look</button>
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t
\t\t\t\t\t\t</div>
\t\t\t\t\t</div>
